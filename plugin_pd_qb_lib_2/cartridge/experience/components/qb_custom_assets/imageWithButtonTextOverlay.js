...
module.exports.render = function (context) {
    ...
    model.contentTop = content.content_top;
    model.contentLeft = content.content_left;
    ...
    return new Template('experience/components/qb_custom_assets/imageWithButtonTextOverlay').render(model).text;
};