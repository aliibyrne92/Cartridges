...
module.exports.render = function (context) {
    ...
    if(content.text){
        ...
        model.textBgColour = (content.text_bg_colour) ? content.text_bg_colour.value : '';
        model.textBgHovColour = (content.text_bg_hov_colour) ? content.text_bg_hov_colour.value : '';
        model.textPad = content.text_pad;
    }

    model.textAbove = (content.show_text_above)? 'block': 'none';
    model.textBelow = (!content.show_text_above)? 'block': 'none';
    ...
    if (content.image) {
        ...
        model.imageBg = (content.image_bg) ? content.image_bg.value : '';
