...
module.exports.render = function (context) {
    ...
    model.tab1Title = content.tab1_title;
    model.tab2Title = content.tab2_title;

    return new Template('experience/components/qb_custom_layouts/tabContent').render(model).text;
};
